...
const checkpointProtocolResponse = {
  ...
  packet_id: checkpointProtocolResult.checkpoint_packet.packet_id,
...
const backgroundCheckpointResponse = {
  ...
  packet_id: backgroundCheckpointStatus.checkpoint_packet.packet_id,
...
const checkpointProtocolBlockedDuplicateResponse = {
  ...
  packet_id: checkpointProtocolBlockedDuplicate.checkpoint_packet.packet_id,
