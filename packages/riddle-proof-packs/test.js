...
assert.deepEqual(neonUiMixerControlMatrix.trackNames, ["guitar"]);
assert.deepEqual(neonUiMixerControlMatrix.viewportNames, ["desktop", "phone"]);
assert.equal(neonUiMixerControlMatrix.cells.length, 2);
assert.equal(neonUiMixerControlMatrix.cells[0], neonUiMixerControlMatrix.viewports[0]);
...
assert.match(neonUiMixerControlMatrixMarkdown, /tracks: `guitar`/u);
assert.match(neonUiMixerControlMatrixMarkdown, /viewports: `desktop, phone`/u);
assert.match(neonUiMixerControlMatrixMarkdown, /## Matrix Cells/u);
